...
class Article {
    ...
    public function update($id, $title, $subtitle, $content) {
        $sql = "UPDATE articles SET title = ?, subtitle = ?, content = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?";
        $stmt = $this->db->prepare($sql);
    ...
    public function updateStatus($id, $status) {
        $sql = "UPDATE articles SET status = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?";
        $stmt = $this->db->prepare($sql);
